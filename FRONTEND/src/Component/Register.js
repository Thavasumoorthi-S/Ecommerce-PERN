 ...
 const handsubmit=(e)=>{
    ...
    return (
        ...
        <div className='register'>
            ...
            <div className="inner"> 
                <label>EMAIL</label>
                <input className='email' name='email' type="email" onChange={(e)=>setemail(e.target.value)} required />

            </div>
            <div className="inner">
                <label>PASSWORD</label>
                <input className='password' name='password' type="text"onChange={(e)=>setpassword(e.target.value)} required />
